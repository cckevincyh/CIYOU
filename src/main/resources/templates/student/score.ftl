...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="min-height: 200px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
          <li class="active"><i class="fa fa-search"></i> 我的成绩</a></li>
      </ol>
    </section>
              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header with-border">
                          ...
                          <div class="box-tools">
                              <form class="form-horizontal" action="${base}/student/queryScore" method="get">
                          ...
                          <#if pageInfo?? && pageInfo.list?? && (pageInfo.list?size > 0) >
                              <#list pageInfo.list as score>
                                  <tr>
                                      ...
                                      <td>
                                          <input type="hidden" id="score_action" value="${base}/student/getScore"/>
...
<script src="${base}/static/js/student/score/score.js"></script>
</body>
</html>
