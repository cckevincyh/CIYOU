          ...
          <div class="row">
              <div class="col-xs-12">
                  <div class="box">
                      <!-- /.box-header -->
                      <div class="box-body">
                          <div class="col-md-6 col-sm-4"><button class="btn btn-default btn-xs" id="btn_add" data-toggle="modal" data-target="#addModal"><i class="fa fa-fw fa-plus"></i></button> 添加年级</div>
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <#list grades as grade>
                              <tr>
                                  ...
                                  <td><button class="btn btn-warning btn-xs"  data-toggle="modal" data-target="#updateModal" onclick="updateGrade(${grade.gradeId!})"><i class="fa fa-fw fa-edit"></i></button>  <button class="btn btn-danger btn-xs" onclick="deleteGrade(${grade.gradeId!})"><i class="fa fa-fw fa-trash"></i></button></td>
                              </tr>
                            </#list>
                              </tbody>
                          </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="addGradeName"  placeholder="请输入年级">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="addGrade"><i class="fa fa-save"></i>
                        保存
                    </button>
                </div>
            </div><!-- /.modal-content -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateGradeId" readonly="readonly">
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">年级</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="updateGradeName"  placeholder="请输入年级">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="updateGrade"><i class="fa fa-save"></i>
                        保存
                    </button>
                </div>
            </div><!-- /.modal-content -->
