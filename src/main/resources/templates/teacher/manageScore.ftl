  ...
  <div class="content-wrapper" style="min-height: 200px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-search"></i> 成绩查询</a></li>
      </ol>
    </section>
              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header with-border">
                          ...
                          <div class="box-tools">
                              <form class="form-horizontal" action="${base}/teacher/queryScore" method="get">
                      ...
                      <div class="box-body table-responsive no-padding">
                          ...
                          <#if pageInfo?? && pageInfo.list?? && (pageInfo.list?size > 0) >
                              <#list pageInfo.list as score>
                                  <tr>
                                      <td>${score.quiz.quizName!}</td>
                                      <#if score.quiz.subject??>
                                          <td>${score.quiz.subject.subjectName!}</td>
                                      <#else >
                                            <td></td>
                                      </#if>
                                      <#if score.quiz.grade??>
                                          <td>${score.quiz.grade.gradeName!}</td>
                                      <#else >
                                          <td></td>
                                      </#if>
                                      <td>${score.quiz.quizTime!}分钟</td>
                                      <#if score.quiz.teacher??>
                                      <td>${score.quiz.teacher.name!}</td>
                                      <#else >
                                          <td></td>
                                      </#if>
                                      <#if score.student??>
                                      ...
                                      <td>
                                          <input type="hidden" id="score_action" value="${base}/teacher/getScore"/>
                                          <button type="button" class="btn btn-success btn-xs" onclick="score(${score.scoreId!})"><i class="fa fa-search"></i></button>
                                      </td>
                                  </tr>
                              </#list>
                          <#else >
...
<script src="${base}/static/js/teacher/score/score.js"></script>
</body>
</html>
