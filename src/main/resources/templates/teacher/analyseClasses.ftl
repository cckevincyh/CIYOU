...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="min-height: 200px;">
    ...
    <section class="content-header">
      <h1>
          班级分析
          <small>班级小测成绩分析</small>
      </h1>
      <ol class="breadcrumb">
          <li><a href="${base}/teacher/index"><i class="fa fa-home"></i> 首页</a></li>
          <li class="active"><i class="fa fa-bar-chart"></i> 班级分析</a></li>
      </ol>
    </section>
                          ...
                          <#if pageInfo?? && pageInfo.list?? && (pageInfo.list?size > 0) >
                              <#list pageInfo.list as roster>
                                  <tr>
                                      ...
                                      <td>
                                          <button class="btn btn-success btn-xs" onclick="analyseClasses(${roster.rid!})"><i class="fa fa-bar-chart"></i>
                                          </button>
                                      </td>
                                  </tr>
                              </#list>
