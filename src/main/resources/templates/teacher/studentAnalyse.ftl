  ...
  <div class="content-wrapper" style="min-height: 200px;">
    ...
    <section class="content-header">
      <h1>
            ...
            ${student.name!}的成绩分析
            <small>${student.name!}的小测成绩分析</small>
      </h1>
      <ol class="breadcrumb">
          <li><a href="${base}/teacher/index"><i class="fa fa-home"></i> 首页</a></li>
          <li><a href="${base}/teacher/analyseStudent"><i class="fa fa-bar-chart"></i> 学生分析</a></li>
          <li class="active"><i class="fa fa-bar-chart"></i>  ${student.name!}的小测成绩分析</a></li>
      </ol>
    </section>
...
<script src="${base}/static/js/teacher/analyse/studentAnalyse.js"></script>
</body>
</html>
