  ...
  <div class="content-wrapper" style="min-height: 200px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-bar-chart"></i> 学生分析</a></li>
      </ol>
    </section>
              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header with-border">
                          ...
                          <div class="box-tools">
                              <form class="form-horizontal" action="${base}/teacher/queryAnalyseStudent" method="get">
                          ...
                          <#if pageInfo?? && pageInfo.list?? && (pageInfo.list?size > 0) >
                              <#list pageInfo.list as student>
                                  <tr>
                                      ...
                                      <td>
                                          <button class="btn btn-success btn-xs" onclick="analyseStudent(${student.sid!})"><i class="fa fa-bar-chart"></i>
                                          </button>
                                      </td>
                                  </tr>
                              </#list>
...
<script src="${base}/static/js/teacher/analyse/analyseStudent.js"></script>
</body>
</html>
